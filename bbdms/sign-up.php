...
<body>
 ...
 <div class="login px-4 mx-auto mw-100">
                            <h5 class="text-center mb-4">REGISTER NOW AS DONOR</h5>
...
<?php }} ?>
                                ...
                                <div class="form-group">
                                    <label>Message</label>
                                    <textarea class="form-control" name="message" placeholder="Please tell whether you want to be donor /Suffering from Disease" required> </textarea>
                                </div>
                                <div class="form-group">
