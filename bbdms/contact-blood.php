...
$sql="INSERT INTO  tblbloodrequirer(BloodDonarID,name,EmailId,ContactNumber,BloodRequirefor,Message,Blood) VALUES(:cid,:name,:email,:contactno,:brf,:message)";
...
<head>
    <title>SAVIOUR | Blood Request </title>
    <!-- Meta tag Keywords -->
                ...
                <div class="col-lg-7 contact-right-w3l">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                             ...
                             <select  class="form-control" id="phone" name="brf">
                                    <option value="">Blood Require For</option>
                                    <option value="Father">B+</option>
                                    <option value="Mother">B-</option>
                                    <option value="Brother">O+</option>
                                    <option value="Sister">O-</option>
