...
<head>
	<title>SAVIOUR | Blood Donor List </title>
	<!-- Meta tag Keywords -->
	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			...
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">Here is the list of people available for Donating Blood.</p>
				<a class="btn btn-lg btn-secondary btn-block login-button ml-lg-5 mt-lg-0 mt-4 mb-lg-0 mb-3" href="search-donor.php"> Search Donor</a>
			</div>
			<div class="d-flex">
