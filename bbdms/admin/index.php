...
<head>
	...
	<title>SAVIOUR | ADMIN LOGIN</title>
...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/banner3.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
					<h1 class="text-center text-bold text-dark mt-4x ">ADMIN LOGIN</h1>
